    ...
    public partial class DoozyWindow
    {
        ...
        private void DrawGeneralLanguageOption()
        {
            ...
            GUILayout.BeginHorizontal(GUILayout.ExpandWidth(true));
            {
                ...
                Doozy.Engine.Language currentLanguage = LanguagePack.CurrentLanguage;
                EditorGUI.BeginChangeCheck();
                GUILayout.BeginVertical();
                GUILayout.Space(0);
                currentLanguage = (Doozy.Engine.Language) EditorGUILayout.EnumPopup(currentLanguage, GUILayout.Width(DGUI.Properties.DefaultFieldWidth * 3));
                GUILayout.EndVertical();
                if (EditorGUI.EndChangeCheck())
                    if (currentLanguage != Doozy.Engine.Language.Unknown)
